...
int* d_adjListGlobal;
int* d_adjListStartIndicesGlobal;
int* d_cantorPairsGlobal;
int* d_weightsGlobal;
...
__global__ void explore(int* d_solution, int* d_score, Candidate* d_globalCandidates)
{
...
void optimizeSolutionOnGPU(int* d_solution, int* d_score, Candidate* d_globalCandidates, int cost)
{
    ...
    do {
        ...
        explore << <NUM_BLOCKS, NUM_CORES / NUM_BLOCKS >> > (d_solution, d_score, d_globalCandidates);
